...
def gfg():
    if request.method == "POST":
        ...
        if seconds >= 1900:
              zoom = '13'
        url = "https://maps.googleapis.com/maps/api/staticmap?center=" + midReverseResultsAddress + "&zoom=" + zoom + "&size=600x300&maptype=roadmap&markers=color:red%7Clabel:B%7C" + url_geocode_lat + "," + url_geocode_lng + "&markers=color:black%7Clabel:A%7C" + latitude1 + "," + longitude1 + "&key=AIzaSyDGzP0Xzw5hVQ7FxHtKgZgNJhoPO0KeVno"
